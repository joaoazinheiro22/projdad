...
const listOfUserTypes = ref([
    ...
    {
        'type': 'regular',
        'filterDescription': 'Regular Users'  
    },
    {
        'type': 'admin',
        'filterDescription': 'Admin Users'  
    },
])
    ...
    <div class="py-2">
        ...
        <div class="flex flex-wrap px-1 space-x-3">
            <div class="ps-3 py-1 text-sm leading-10 flex space-x-1 grow">
                ...
                <select id="input_filter_user_type_id" class="p-2 grow h-10 border-gray-300 border rounded-lg text-base"            
                    v-model="filterByType">
                    <option v-for="t in listOfUserTypes" :value="t">{{ t ? t.filterDescription : '-- Any --' }}</option>
                </select>
            </div>
            ...
            <div class="py-1 text-sm leading-10 flex shrink-0 space-x-1 ">
                ...
                <select id="input_filter_blocked_id" class="p-2 grow h-10 border-gray-300 border rounded-lg text-base"            
                    ...
                    <option v-for="b in listOfBlockedStatus" :value="b">{{ b ? b.filterDescription : '-- Any --' }}</option>
                </select>
            </div>       
